...
const Player: React.FC<PlayerProps> = ({ number, name, bgColor, onClick, style }) => (
 <div
   className="flex flex-col gap-2 justify-center text-center cursor-pointer"
   onClick={onClick}
   style={style}
 >
   <div
   ...
   <h3 className="text-white text-sm leading-[21px] font-medium w-[60%] mx-auto">
     {name}
   </h3>
 </div>
);
...
const Team: React.FC<TeamProps> = ({
 ...
 return (
   <div className="relative">
     ...
     <div
       className={`absolute top-0 grid grid-cols-4 h-full w-full -left-[93px] p-5 ${
         hide ? "hidden" : "block"
       }`}
     >
       <div className="flex flex-col gap-2 justify-center text-center">
         <Player
           ...
           style={{ position: 'relative', right: '-68px' }}
         />
       </div>
